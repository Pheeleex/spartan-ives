            ...
            <div className="review-container flex flex-col lg:flex-row items-center h-full">
                <div className="describe border-r-[1px] border-red-200 w-full lg:w-[50%] h-full">
                    <div className="contain flex flex-col justify-center items-center p-8 gap-4">
                        ...
                        <p>
                            Our clients and investors are at the heart of what we do – and their feedback speaks 
                            volumes about the success of our property investment mission. Beautiful homes. Sustainable growth.
                        </p>
                ...
                >
                    {reviews.map((review, index) => (
                        <SwiperSlide key={index} className='swipe flex flex-col justify-center items-center w-[50%] p-8 
